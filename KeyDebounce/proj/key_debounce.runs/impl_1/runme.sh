...
HD_PWD='C:/Users/mingf/Desktop/github/my_fpga_utilities/KeyDebounce/proj/key_debounce.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log key_jitter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source key_jitter.tcl -notrace
