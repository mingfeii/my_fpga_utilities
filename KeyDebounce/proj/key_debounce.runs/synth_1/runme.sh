...
HD_PWD='C:/Users/mingf/Desktop/github/my_fpga_utilities/KeyDebounce/proj/key_debounce.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log key_jitter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source key_jitter.tcl
