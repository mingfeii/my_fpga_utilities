...
HD_PWD='C:/Users/mingf/Desktop/github/ddr3_hdmi/ddr3_hdmi.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_ddr3_hdmi_ctrl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_ddr3_hdmi_ctrl.tcl
