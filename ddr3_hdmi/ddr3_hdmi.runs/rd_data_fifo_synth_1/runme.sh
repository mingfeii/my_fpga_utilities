...
HD_PWD='C:/Users/mingf/Desktop/github/ddr3_hdmi/ddr3_hdmi.runs/rd_data_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rd_data_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rd_data_fifo.tcl
