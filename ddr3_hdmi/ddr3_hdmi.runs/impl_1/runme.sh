...
HD_PWD='C:/Users/mingf/Desktop/github/ddr3_hdmi/ddr3_hdmi.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_ddr3_hdmi_ctrl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_ddr3_hdmi_ctrl.tcl -notrace
